...
-- Weld TODAS las partes del modelo al handle invisible
-- asi todo se mueve junto cuando el jugador camina
-- ============================================
local function createCarryTool(player, model)
        ...
        if model then
                ...
                -- Desanclar todo y hacer massless
                ...
                -- Weld TODAS las BaseParts al handle
                -- Esto asegura que todas las partes del modelo se mueven
                -- junto con el handle de la herramienta
                for _, desc in ipairs(modelClone:GetDescendants()) do
                        if desc:IsA("BasePart") then
...
Events.DropCharacter.OnServerEvent:Connect(function(player)
        ...
        if charData.model then
                ...
                -- Anclar todo primero para poder posicionar con CFrame
                ...
                -- Mover modelo a la posicion usando part.Position + offset
